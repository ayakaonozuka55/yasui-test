      ...
      <section class="request_form ">
        <div class="l-content-sm">
          <div class="heading-a">
            ...
            <p class="head_text">下記ボタンよりお問い合わせフォームに<br class="visible-xs">遷移してください。</p>
              <div class="c-btn btn-a form_btn">
                <a href="https://form.k3r.jp/yasuikensetsu/otoiawasenew02" target="_blank" class="contact_btn">お問い合わせフォーム</a>
              </div>
          </div>
          <!-- <div class="form">
            ...
            <form action="https://form.k3r.jp/yasuikensetsu/otoiawasenew" onSubmit="return checkSubmit();" method="POST" name="Form1">
              ...
              <div class="form_privacy">
            	...
            	<input type="hidden" name="red" value="<?php echo home_url(); ?>/contact-thanks" />
