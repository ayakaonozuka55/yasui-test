...
$title = str_replace('スタッフブログ', 'すべて', $title);
$title .='の';
?>
      ...
      <div class="l-content-sm cf">
        <article class="main_body">
          <div class="lead lead-a">
            <h1 class="lead-a_heading lead_heading"><?php echo $title; ?>ブログ記事一覧</h1>
            <div class="text">
              <p><?php echo $title; ?>家づくりの裏話やプライベートで日々思うことをブログで更新中！</p>
            </div>
          </div>
