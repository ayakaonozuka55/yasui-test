...
$results = $wpdb->get_results("
    ...
    WHERE  B.taxonomy = 'media_category' 
		AND B.count != '0' 
...
foreach ($results as $value) :
	...
	$oyaname = $value->name;
?>
      <li><a href="<?php echo home_url(); ?>/media_category/<?php echo $oyaslug; ?>"><?php echo $oyaname; ?></a></li>
<?php endforeach; ?>
    </ul>
...
foreach ($results as $value) :
	...
	$oyaname = $value->name;
?>
		      <option value="<?php echo home_url(); ?>/media_category/<?php echo $oyaslug; ?>"><?php echo $oyaname; ?></option>
<?php endforeach; ?>
        </select>
      </form>
    </div>
