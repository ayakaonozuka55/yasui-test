<article class="latest bg_thinorange">
  <div class="l-content-sm">
    <div class="heading-a heading-a-ex">
      <h2 class="head"><span class="line">リフォーム・リノベーションの<br class="visible-xs"><span class="c-orange">イベント情報</span></span></h2>
    </div>
...
date_default_timezone_set('Asia/Tokyo');
    ...
    'tax_query' => array(
        array(
            'taxonomy' => 'event_brand',
            'field' => 'slug',
            'terms' => 'eventbrand-reform'
        ),
    ),
		'post_type' => 'event',
		'posts_per_page'=>'4',
...
<?php wp_reset_query();endif; ?>
    ...
    <div class="btn-a">
      <a href="<?php echo home_url(); ?>/event_brand/eventbrand-reform">もっと見る</a>
    </div>
  </div>
</article>
