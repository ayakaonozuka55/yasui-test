...
?>
  ...
  <main class="main staffblog detail oya">
      ...
      <div class="l-content-sm cf">
        <article class="main_body">
          <div class="lead lead-a">
            <h1 class="lead-a_heading lead_heading">お客様の声を<?php single_cat_title() ?></h1>
            <div class="lead_text"><?php echo term_description($tax_id); ?></div>
          </div>
          <div class="archive">
...
");
            ...
            echo '      <h2 class="head">' . $child_val -> name . 'のお客様の声</h2>'."\n";
            echo '    </div>'."\n";
...
<?php endwhile; ?>
                ...
                <div class="archive_body_item_foot">
                  <div class="btn-a btn">
                    <a href="<?php echo $cat_link; ?>"><?php echo $child_val -> name; ?>のお客様の声をもっと見る</a>
                  </div>
                </div>
